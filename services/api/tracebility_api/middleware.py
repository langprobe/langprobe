...
log = structlog.get_logger("tracebility.api.middleware")
...
def install(app: FastAPI) -> None:
    ...
    if getattr(audit.record, "_tracebility_audit_patched", False):
        return
    ...
    tracked._tracebility_audit_patched = True  # type: ignore[attr-defined]
