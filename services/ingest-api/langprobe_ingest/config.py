...
class Settings:
    ...
    # and the langprobe-clickhouse secret created by the bootstrap runbook).
    clickhouse_url: str
    ...
    disk_buffer_path: str = "/var/lib/langprobe/ingest-buffer"
...
def load() -> Settings:
    ...
    return Settings(
        ...
        inline_blob_max_bytes=int(os.environ.get("LANGPROBE_INLINE_BLOB_MAX_BYTES", "1000000")),
        ...
        bind_port=int(os.environ.get("LANGPROBE_BIND_PORT", "7080")),
        redact_pii=os.environ.get("LANGPROBE_REDACT_PII", "true").lower()
