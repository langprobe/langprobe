...
Per spec §5.6: replace single ``langprobe:ingest:v1`` with N shards
``langprobe:ingest:v1:{0..N-1}``. One runaway org fills its shard, not the
...
STREAM_PREFIX: Final = "langprobe:ingest:v1"
